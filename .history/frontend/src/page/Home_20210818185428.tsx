...
const Home : React.FC= () => {
   ...
   const [respostaMatematicaContext , setRespostaMatematica] = useState<respostaType>({} as respostaType)
   const [respostaHistoria , setRespostaHistoria] = useState<respostaType>({} as respostaType)
   const [respostaGeografia , setRespostaGeografia] = useState<respostaType>({} as respostaType)
type respostaType = {
   p1 : string ,
   p2 : string ,
   p3 : string ,
