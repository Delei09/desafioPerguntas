...
const nota = ( (resultadoGeografia.length + resultadoHistoria.length + resultadoMatematica.length ) * 8.34 )
 ...
 return(
  <div className = 'divResultado'>
     ...
     <h2 className = 'h2Resultado'> <span className = {nota >= 70 ? 'notaVerde' : 'notaVermelho'}>   {nota > 70 ?   `Parabéns! Você tirou ${ Math.round(nota)} ` : `Infelizmente Você tirou ${Math.round(nota)}`}  </span>   </h2>
