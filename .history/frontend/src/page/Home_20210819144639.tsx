...
<>
   ...
   <div className="exemplo-radio">    <input type="radio" value="0" name="campo-radio" id="campo-radio1" />    <label htmlFor="campo-radio1">Opção</label>    <input type="radio" value="0" name="campo-radio" id="campo-radio2" />    <label htmlFor="campo-radio2">Opção</label></div><div className="exemplo-checkbox">    <input type="checkbox" value="0" name="campo-checkbox" id="campo-checkbox1" />    <label htmlFor="campo-checkbox1">Opção</label>    <input type="checkbox" value="0" name="campo-checkbox" id="campo-checkbox" />    <label htmlFor="campo-checkbox">Opção</label></div>
