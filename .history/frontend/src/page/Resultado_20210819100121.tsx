...
const respGraficoGeo = {
    ...
    useEffect( () => {
        console.log(`resposta geografia = ${respGeo}`)
            const r =     perguntasGeografia.filter( ({resposta}) => {
            console.log(`item resposta correta da pergunta ${resposta}`)
            return resposta === respGeo.p1 || respGeo.p2 || respGeo.p3 ||respGeo.p4 })

            console.log(r)
        } )
        console.log(respGeo.p1 + ' fora do efect')
 return(
