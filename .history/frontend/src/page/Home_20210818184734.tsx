...
const Home : React.FC= () => {
   ...
   const [resposta , setResposta] = useState<respostaType>({} as respostaType)
type respostaType = {
   p1 : string ,
   p2 : string ,
   p3 : string ,
...
const inicialResposta= {
   ...
   const {perguntasMatematica, perguntasHistoria, perguntasGeografia, setResposta, resposta}  = useContext(ContextPerguntas)
