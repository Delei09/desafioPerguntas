...
const respGraficoGeo = {
 ...
 return(
  <div className = 'divResultado'>
     ...
     <h2 className = 'h2Resultado'>Parabens! Você tirou {  Math.round((   (resultadoGeografia.length + resultadoHistoria.length + resultadoMatematica.length)  * 8.33 ) ).toFixed(2) }.</h2>
