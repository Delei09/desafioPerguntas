...
const [resultadoMatematica, setResultadoMatematica] = useState<[any]>()
const [resultadoHistoria, setResultadoHistoria] = useState<[any]>()
const [resultadoGeografia, setResultadoGeografia] = useState<[any]>()
